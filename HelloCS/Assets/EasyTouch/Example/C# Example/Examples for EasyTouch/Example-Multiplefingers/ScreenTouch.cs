...
public class ScreenTouch : MonoBehaviour {
	...
	void On_TouchStart(Gesture gesture){
		...
		if (gesture.pickObject==null){
			...
			sphere.GetComponent<Renderer>().GetComponent<Material>().SetColor ("_TintColor", color);
			spot.GetComponent<Renderer>().GetComponent<Material>().SetColor ("_TintColor",color);
